...
describe('assertion verification, basic', function() {
  ...
  it('validation of assertion with newlines in the email should fail', function(done) {
    client = new Client({
      idp: idp,
  ...
  it('validation of assertion with null bytes in the email hostname should fail', function(done) {
    client = new Client({
      idp: idp,
      email: 'test@users.example\u0000.com'
    });
  ...
  it('validation of assertion with null bytes in the email username should fail', function(done) {
    client = new Client({
      idp: idp,
      email: 'test\u0000@users.example.com'
    });
  ...
  it('validation of assertion with regex-busting newline should fail', function(done) {
    client = new Client({
      idp: idp,
      email: 'test@users.example.com\u0000\n@example.com'
    });
